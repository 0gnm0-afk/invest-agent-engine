...
# These immutable pre-manifest snapshots were reviewed before restoration.
HISTORICAL = {'e18ba63f81b46232b43089a006364a25cb7dd20f',
              '0ba5426a8a6401898a183a412c5c36d8702d1a6e'}
...
def inspect(repo, ref='HEAD'):
    ...
    for oid in commits:
        ...
        # Retain historical public AI attribution; permit only its exact known address.
        scan(re.sub(rb'noreply[@]anthropic[.]com', b'[public AI attribution]', raw)
             if oid in HISTORICAL else raw)
        ...
        if oid == BASELINE or oid in HISTORICAL:
            continue
